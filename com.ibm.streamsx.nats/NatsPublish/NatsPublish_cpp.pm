...
sub main::generate($$) {
   ...
   print "\n";
   print '    SPL::blob content = ';
   print SPL::CodeGen::adaptCppExpression($content, "tuple");
   print ';', "\n";
   print "\n";
   print '    natsConnection_Publish(this->conn, content.getData(), content.getSize());', "\n";
   print '}', "\n";
   print "\n";
